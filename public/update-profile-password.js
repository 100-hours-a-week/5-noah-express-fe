...
function changeButtonColor() {
    updateProfilePasswordButton.style.backgroundColor = validteAll() ? '#7F6AEE' : '#ACA0EB';
}
...
const updateUserPasswordForm = document.getElementById('update-user-password-form');

updateUserPasswordForm.addEventListener('submit', (event) => {
    event.preventDefault();

    fetch(`${SERVER_ADDRESS}:${SERVER_PORT}/api/users/update/password`, {
        method: 'POST', headers: {
